<script lang="ts">
	...
	function getTeams(match: MatchRecord) {
		return {
	...
	function getEnemyAllyTeams(match: MatchRecord) {
	...
	// --- Advice parsing (mirrors match page logic) ---
	function parseAdvice(match: MatchRecord): ParsedAdvice | null {
	...
	// --- Name highlighting ---
	function buildNameFragments(match: MatchRecord): Set<string> {
	...
	// Helper: get advice for a specific player by index in their team
